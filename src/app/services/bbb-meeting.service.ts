...
export class BbbMeetingService {
  ...
  createMeeting(meetingid): Observable<any> {
    // API path
    const base_path =
      'https://manager.bigbluemeeting.com/bigbluebutton/api/create?allowStartStopRecording=true&attendeePW=ap&autoStartRecording=false&meetingID=52a7815e00c6fd6fe2e645756d29d87488d46192&moderatorPW=mp&name=random-5840789&record=false&welcome=%3Cbr%3EWelcome+to+%3Cb%3E%25%25CONFNAME%25%25%3C%2Fb%3E%21';
    const secretSalt = 'vuCrGBy5Sj8CxFIQdhmXkejLYQBGfUjlHUwptqadCa';
    const checksum = CryptoJS.SHA1(
      'createallowStartStopRecording=true&attendeePW=ap&autoStartRecording=false&meetingID=' +
        meetingid +
        '&moderatorPW=mp&name=random-5840789&record=false&welcome=%3Cbr%3EWelcome+to+%3Cb%3E%25%25CONFNAME%25%25%3C%2Fb%3E%21' +
        secretSalt
    );
