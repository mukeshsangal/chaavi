...
export class GetActionEventsByCoursesService {
...
// Get Calendar Events to set as Notification on Home Tab
getActionEvents(userId): Observable<any> {
  var base_path2 = this.base_path+ '&userid=' + userId;
